...
// 【练习题】
// ================================================================
// 1. 实现一个线程安全的单例模式，并验证多线程环境下的连接安全
// 2. 用 std::function 和 lambda 实现一个策略模式，支持替换策略算法
// 3. 编写一个简单元的工具类，实现功能法分程（参数校验、日志统计、错误缝合）
// 4. 设计一个工具类，实现性能分析法分段（参数校验、日志统计、错误缝合）
// 5. 编写一个简单元的代码审单例，对审视代码进行 SOLID 原则审单
